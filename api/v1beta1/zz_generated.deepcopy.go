...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DownloadOptions) DeepCopyInto(out *DownloadOptions) {
	*out = *in
	if in.Env != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DownloadOptions.
func (in *DownloadOptions) DeepCopy() *DownloadOptions {
	if in == nil {
		return nil
	}
	out := new(DownloadOptions)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PresetSpec) DeepCopyInto(out *PresetSpec) {
	*out = *in
	...
	in.DownloadOptions.DeepCopyInto(&out.DownloadOptions)
}
